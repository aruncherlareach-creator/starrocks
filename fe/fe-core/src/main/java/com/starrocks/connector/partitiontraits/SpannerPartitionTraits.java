 ...
 * Spanner tables are always unpartitioned in Phase 1, so partition-aware
 * MV refresh is not supported.
 */
public class SpannerPartitionTraits extends DefaultTraits {
    @Override
    ...
    public PartitionKey createEmptyKey() {
        return new SpannerPartitionKey();
    }
}
