...
public class PhysicalSpannerScanOperator extends PhysicalScanOperator {
    private ScanOperatorPredicates predicates;

    public PhysicalSpannerScanOperator(LogicalSpannerScanOperator scanOperator) {
        super(OperatorType.PHYSICAL_SPANNER_SCAN, scanOperator);
    ...
    public <R, C> R accept(OperatorVisitor<R, C> visitor, C context) {
        return visitor.visitPhysicalSpannerScan(this, context);
    }

    @Override
    public <R, C> R accept(OptExpressionVisitor<R, C> visitor, OptExpression optExpression, C context) {
        return visitor.visitPhysicalSpannerScan(optExpression, context);
    }
